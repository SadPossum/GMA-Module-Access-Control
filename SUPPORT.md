...
GMA Access Control Module is independently versioned. The `dev` branch is the changing integration line; immutable SemVer tags are release boundaries.

| Channel | Status |
| --- | --- |
| `dev` | Pre-release integration |
| `v0.1.0` | Current tagged release |
