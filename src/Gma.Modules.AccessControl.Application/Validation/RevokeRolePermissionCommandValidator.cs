...
internal sealed class RevokeRolePermissionCommandValidator : ICommandValidator<RevokeRolePermissionCommand>
{
    public IEnumerable<string> Validate(RevokeRolePermissionCommand command)
    {
