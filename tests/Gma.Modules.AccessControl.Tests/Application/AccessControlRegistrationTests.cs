...
public sealed class AccessControlRegistrationTests
{
    ...
    public void Application_registration_is_idempotent()
    {
        ...
        Assert.Single(services, HasService<IAccessProfileManager, AccessProfileManager>());
        Assert.Single(services, HasService<IScopedAccessProfileManager, ScopedAccessProfileManager>());
